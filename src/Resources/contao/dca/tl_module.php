...
$dca['subpalettes']['paginationMode_'.NewsPaginationBundle::MODE_AUTO] = 'addTextualPagination,paginationMaxCharCount,avoidTrailingHeadlines,paginationCeTextCssSelector,fullVersionGetParameter,acceptPrintGetParameter,addFullVersionCanonicalLink,addPrevNextLinks,templatePagination';
$dca['subpalettes']['paginationMode_'.NewsPaginationBundle::MODE_MANUAL] = 'addTextualPagination,fullVersionGetParameter,acceptPrintGetParameter,addFullVersionCanonicalLink,addPrevNextLinks,templatePagination';
$dca['subpalettes']['paginationMode_'.NewsPaginationBundle::MODE_MANUAL_WITH_AUTO_FALLBACK] = 'addTextualPagination,paginationMaxCharCount,avoidTrailingHeadlines,paginationCeTextCssSelector,fullVersionGetParameter,acceptPrintGetParameter,addFullVersionCanonicalLink,addPrevNextLinks,templatePagination';
...
$fields = [
    'paginationMode' => [
        ...
        'filter' => true,
        'inputType' => 'select',
        'options' => NewsPaginationBundle::MODES,
    ...
    'templatePagination' => [
        ...
        'filter' => true,
        'inputType' => 'select',
        'options_callback' => [HeimrichHannot\NewsPaginationBundle\DataContainer\ModuleContainer::class, 'getPaginationTemplate'],
        'reference' => &$GLOBALS['TL_LANG']['tl_module']['reference']['newsPaginationBundle'],
        'eval' => ['tl_class' => 'w50', 'includeBlankOption' => true, 'submitOnChange' => true],
    ...
    'fullVersionGetParameter' => [
        ...
        'sql' => "varchar(32) NOT NULL default 'full'",
    ],
